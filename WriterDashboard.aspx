<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WriterDashboard.aspx.cs" Inherits="JamesArticleApp.WriterDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="row" id="divArticlesInfo">
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                               <div class="col-lg-12 col-sm-3">
                                    Title
                                    <input type="date" id="iatitle" class="form-control" style="width:100%;" tabindex="3"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-sm-3">
                    ...
                    <div class="row" id="divUpdateArticleInfo">
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                               <div class="col-lg-12 col-sm-3">
                                    Title
                                    <input type="date" id="uatitle" class="form-control" style="width:100%;" tabindex="3"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-sm-3">
    ...
    <script>document.write('<script src="Scripts/custom/js/jsWriterDashboard.js?v=' + (new Date()).getTime() + '"\><\/script>');</script>
